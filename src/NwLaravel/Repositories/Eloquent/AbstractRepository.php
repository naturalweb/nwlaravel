...
abstract class AbstractRepository extends BaseRepository implements RepositoryInterface
{
    ...
    {
        $pattern = '/^(((where|orWhere).*)|with|withCount|without|select|limit|offset|forPage|groupBy|inRandomOrder|orderByRaw|union|join|leftJoin|rightJoin|crossJoin|withTrashed|withoutTrashed|onlyTrashed)$/';
